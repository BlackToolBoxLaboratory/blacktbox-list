...
var Menu = function (_React$Component) {
  ...
  _createClass(Menu, [{
    ...
    value: function render() {
      ...
      props_layer.className += ' layer-' + nextLayer;
      if (this.env.styleObj['layer-' + nextLayer]) {
        Object.keys(this.env.styleObj['layer-' + nextLayer]).map(function (config) {
          props_layer.style[config] = _this3.env.styleObj['layer-' + nextLayer][config];
        });
      };
        ...
        _react2.default.createElement(
          ...
          function () {
            ...
            listArr.map(function (item) {
              content_layer.push(_this3.listRenderFn(item, nextLayer));
            });
    ...
    value: function listRenderFn(source, layerCounter) {
      ...
      if (this.env.styleObj['layer-' + layerCounter]) {
        if (this.env.styleObj['layer-' + layerCounter]['list-style-type']) {
          props_item.style['list-style-type'] = this.env.styleObj['layer-' + layerCounter]['list-style-type'];
        };
      };
      ...
      content.push(_react2.default.createElement(
        ...
        function () {
          ...
          if (hasChildren) {
            ...
            props_layer.className += ' layer-' + nextLayer;
            if (_this5.env.styleObj['layer-' + nextLayer]) {
              Object.keys(_this5.env.styleObj['layer-' + nextLayer]).map(function (config) {
                props_layer.style[config] = _this5.env.styleObj['layer-' + nextLayer][config];
              });
            };
              ...
              _react2.default.createElement(
                ...
                function () {
                  ...
                  infoObj.children.map(function (item) {
                    content_layer.push(_this5.listRenderFn(item, nextLayer));
                  });
                  return content_layer;
                }()
              )
